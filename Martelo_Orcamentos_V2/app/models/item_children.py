...
class _DadosItemsBase(Base, _ChildBase):
    __abstract__ = True
    # Colunas genéricas para itens
...
class DadosItemsMateriais(_DadosItemsBase):
    ...
    custo_mp_und = Column(Numeric(12, 2))
    custo_mp_total = Column(Numeric(12, 2))
    nao_stock = Column(Integer, default=0)


class DadosItemsFerragens(_DadosItemsBase):
...
class DadosItemsSistemasCorrer(_DadosItemsBase):
...
class DadosItemsAcabamentos(_DadosItemsBase):
