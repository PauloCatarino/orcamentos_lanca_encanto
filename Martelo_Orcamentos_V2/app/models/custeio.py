...
class CusteioItem(CusteioContextMixin, Base):
    ...
    icon_hint = Column(String(512), nullable=True)
    qt_mod = Column(Numeric(18, 4), nullable=True)
    qt_und = Column(Numeric(18, 4), nullable=True)
    qt_manual_override = Column(Boolean, nullable=False, default=False)
    ...
    acabamento_sup = Column(String(128), nullable=True)
    acabamento_inf = Column(String(128), nullable=True)
    ...
    perimetro_und = Column(Numeric(18, 4), nullable=True)
