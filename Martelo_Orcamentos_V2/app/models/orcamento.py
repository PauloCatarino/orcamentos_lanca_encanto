...
class OrcamentoItem(Base):
    ...
    margem_lucro_perc = Column(Numeric(6, 2), nullable=True, default=0)
    valor_margem = Column(Numeric(14, 2), nullable=True, default=0)
    custos_admin_perc = Column(Numeric(6, 2), nullable=True, default=0)
    valor_custos_admin = Column(Numeric(14, 2), nullable=True, default=0)
    margem_acabamentos_perc = Column(Numeric(6, 2), nullable=True, default=0)
    valor_acabamentos = Column(Numeric(14, 2), nullable=True, default=0)
    margem_mp_orlas_perc = Column(Numeric(6, 2), nullable=True, default=0)
    valor_mp_orlas = Column(Numeric(14, 2), nullable=True, default=0)
    margem_mao_obra_perc = Column(Numeric(6, 2), nullable=True, default=0)
    valor_mao_obra = Column(Numeric(14, 2), nullable=True, default=0)

    notas = Column(Text, nullable=True)
    extras = Column(JSON, nullable=True)
    custo_colagem = Column(Numeric(14, 2), nullable=True, default=0)
