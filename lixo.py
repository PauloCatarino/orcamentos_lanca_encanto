diff --git a/configurar_guardar_dados_gerais_orcamento.py b/configurar_guardar_dados_gerais_orcamento.py
index c2e2a46b3db6ef2a1f3f5184381ace7ffad2466d..5824c192dacdaeb0bce8417ac621ad05c90af598 100644
--- a/configurar_guardar_dados_gerais_orcamento.py
+++ b/configurar_guardar_dados_gerais_orcamento.py
@@ -13,55 +13,57 @@ A função configurar_dados_gerais realiza o seguinte:
...
--- a/configurar_guardar_dados_gerais_orcamento.py
+++ b/configurar_guardar_dados_gerais_orcamento.py
@@ -177,66 +179,61 @@ def carregar_configuracao_dados_gerais(parent, nome_tabela):
       UI[5]  ← ref_le    (DB[8])
...
--- a/configurar_guardar_dados_gerais_orcamento.py
+++ b/configurar_guardar_dados_gerais_orcamento.py
@@ -246,97 +243,96 @@ def carregar_configuracao_dados_gerais(parent, nome_tabela):
                 texto_formatado = ""
...
--- a/configurar_guardar_dados_gerais_orcamento.py
+++ b/configurar_guardar_dados_gerais_orcamento.py
@@ -382,295 +378,399 @@ def configurar_dados_gerais(parent):
...
+    nome_modelo = f"{num_orc}_{ver_orc}"
...
+    # Usa num_orc e ver_orc separados por '_' como identificador
